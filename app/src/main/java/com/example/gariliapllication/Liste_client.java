...
public class Liste_client extends AppCompatActivity {
    ...
    Adapterrecycle_client adapterrecycleClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycle_view_client);
        ...
        add_client.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Liste_client.this,Add_client.class);
                startActivity(intent);
            }
        });

        db = new BDHelper(Liste_client.this);
        ...
        adapterrecycleClient = new Adapterrecycle_client(Liste_client.this,this,utilisateur_id,utilisateur_nom,utilisateur_prenom,utilisateur_numero,utilisateur_email);

        recyclerView.setAdapter(adapterrecycleClient);
        recyclerView.setLayoutManager(new LinearLayoutManager(Liste_client.this));
    ...
    void AjouterDatadansArray(){
        Cursor cursor = db.readallclient();
        if (cursor.getCount() == 0 ){
            Toast.makeText(Liste_client.this,"pas de donné", Toast.LENGTH_SHORT).show();
        }else {
