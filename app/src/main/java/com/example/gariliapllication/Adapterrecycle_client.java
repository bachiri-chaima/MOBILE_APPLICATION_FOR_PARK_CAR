...
public class Adapterrecycle_client extends RecyclerView.Adapter<Adapterrecycle_client.MyviewHolder> {
    private Context context;
    private ArrayList utilisateur_id,utilisateur_nom,utilisateur_prenom,utilisateur_email,utilisateur_numero;
    Activity activity;

    Animation anim;
    Adapterrecycle_client(Activity activity,Context context, ArrayList utilisateur_id, ArrayList utilisateur_nom, ArrayList utilisateur_prenom, ArrayList utilisateur_numero, ArrayList utilisateur_email) {
    ...
    public MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layout_raw_client,parent,false);
        return  new Adapterrecycle_client.MyviewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull MyviewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,Update_client.class);
    ...
    public class MyviewHolder extends RecyclerView.ViewHolder {
        ...
        public MyviewHolder(@NonNull View itemView) {
            super(itemView);
            id_text = itemView.findViewById(R.id.affiche_id_client);
            nom_text = itemView.findViewById(R.id.nom_client);
            prenom_text = itemView.findViewById(R.id.prenom_client);
            numero_text = itemView.findViewById(R.id.numero_client);
            email_text = itemView.findViewById(R.id.email_client);
            linearLayout = itemView.findViewById(R.id.layout_update_client);
            //animation
