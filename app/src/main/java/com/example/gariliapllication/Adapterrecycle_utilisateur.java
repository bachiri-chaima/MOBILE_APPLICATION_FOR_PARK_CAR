...
public class Adapterrecycle_utilisateur extends RecyclerView.Adapter<Adapterrecycle_utilisateur.MyviewHolder> {
    ...
    Animation anim;
    Adapterrecycle_utilisateur(Activity activity,Context context, ArrayList utilisateur_id, ArrayList utilisateur_nom, ArrayList utilisateur_prenom, ArrayList utilisateur_numero, ArrayList utilisateur_email) {
    ...
    public MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layout_raw_utilisateur,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyviewHolder holder, int position) {
        ...
        //on click sur item lineairelayout
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context,Update_utilisteur.class);
    ...
    public class MyviewHolder extends RecyclerView.ViewHolder {
        ...
        MyviewHolder(@NonNull View itemView) {
            super(itemView);
            id_text = itemView.findViewById(R.id.affiche_id);
            nom_text = itemView.findViewById(R.id.nom_utilisateur);
            prenom_text = itemView.findViewById(R.id.prenom_utilisateur);
            numero_text = itemView.findViewById(R.id.numero_utilisateur);
            email_text = itemView.findViewById(R.id.email_utilisateur);
            linearLayout = itemView.findViewById(R.id.layout_update_utilisateur);
            //animation
